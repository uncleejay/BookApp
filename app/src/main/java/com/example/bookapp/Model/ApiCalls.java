...
public class ApiCalls {
    ...
    public static List<bookModel> fetchBooksData(String url){
    ...
    private static ArrayList<bookModel> extractJson(String json) throws JSONException {
        String title = "title";
        ...
        for(int i=0; i < items.length(); i++){
            ...
            bookModel bookItem = new bookModel(title, author, infoUrl, imageUrl, publisher);
